        ...
        e.customStyles = {}, e.Popup = function () {
            var n = {
                ...
                elements: {
                    ...
                    allow: '<a aria-label="allow cookies" role=button tabindex="0"  class="btn-dpx-dark cc-btn cc-allow">{{allow}}</a>',
                    deny: '<a aria-label="deny cookies" role=button tabindex="0" class="btn-transparent-dark cc-btn cc-deny">{{deny}}</a>',

!function (t, e) {
    ...
    var m = function () {
        ...
        return i(e, [{
            ...
            key: "init", value: function () {
                this.addClasses([v.SHUFFLE_ITEM, v.VISIBLE]), this.applyCss(e.Css.INITIAL2), this.scale = e.Scale.VISIBLE, this.point = new m
            }
        }, {
    ...
    g.Css = {
        INITIAL: {position: "relative", top: 0, left: 0, visibility: "visible", "will-change": "transform"},
        INITIAL2: {position: "absolute", top: 0, left: 0, visibility: "visible"},
    ...
    var O = 0, N = function (e) {
        ...
        return function (t, e) {
            ...
            key: "_validateStyles", value: function (t) {
                "static" === t.position && (this.element.style.position = "relative"), "hidden" !== t.overflow && (this.element.style.overflow = "visible")
            }
        }, {
